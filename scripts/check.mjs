...
const required = ["index.html", "styles.css", "app.js", "manifest.webmanifest", "robots.txt", "BRAND.md", ".env.example", "docs/PRODUCT_AUDIT.md", "docs/RELEASE_REPORT.md", "docs/FINAL_QA_QC_REPORT.md", "assets/favicon.svg", "assets/logo-mark.svg", "assets/logo-lockup.svg", "assets/reexport-saudi.jpg"];
...
for (const behavior of ["history.pushState", "addEventListener(\"popstate\""]) if (!app.includes(behavior)) throw new Error(`Missing navigation behavior: ${behavior}`);
